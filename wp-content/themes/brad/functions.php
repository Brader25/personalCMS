<?php
/**
 * brad functions and definitions.
 *
...
function brad_setup() {
	 ...
	 * If you're building a theme based on brad, use a find and replace
	 * to change 'brad' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'brad' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'brad_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'brad_setup' );
 ...
 */
function brad_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'brad_content_width', 640 );
}
 ...
 */
function brad_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'brad' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'brad' ),
...
add_action( 'widgets_init', 'brad_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'brad_scripts' );
